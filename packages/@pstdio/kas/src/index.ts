...
import { DEFAULT_APPROVAL_GATED_TOOLS, type RequestApproval } from "./approval";
...
export type { RequestApproval, ApprovalRequest } from "./approval";
export { systemPrompt as defaultSystemPrompt } from "./prompts";
export { DEFAULT_APPROVAL_GATED_TOOLS };
