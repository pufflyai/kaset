  ...
  theme: {
    ...
    semanticTokens: {
      colors: {
        ...
        "border.accent": { value: { _light: "#0E6EF6", _dark: "#A8CBFE" } },
        "border.accent-light": { value: { _light: "#A8CBFE", _dark: "#002862" } },
        "border.primary": { value: { _light: "#C5C5C7", _dark: "#5A5F67" } },
        "border.secondary": { value: { _light: "#EAEAEA", _dark: "#444750" } },
        "border.tertiary": { value: { _light: "#EAEAEA", _dark: "#FFFFFF" } },
        "border.inverse": { value: { _light: "#C5C5C7", _dark: "#5A5F67" } },
        ...
        "text.placeholder": { value: { _light: "#94A3B8", _dark: "#475569" } },
      },
    },
    textStyles,
  },
